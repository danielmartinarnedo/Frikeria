            ...
            .then(mensajes => {
                ...
                mensajes.forEach(mensaje => {
                    ...
                    <div class="row d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-11 d-flex justify-items-center align-items-start">
                            <p><span class="me-2">${mensaje.usuarioNom}</span>
                                <svg class="me-1 envarMensajeUsu" data-usuario-nom="${mensaje.usuarioNom}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" style="width: 24px; height: 24px;">
                ...
                const envarMensajeUsu = document.querySelectorAll(".envarMensajeUsu");
                envarMensajeUsu.forEach(function (solicitud) {
                    solicitud.addEventListener("click", function () {
                        const usuarioNom = this.getAttribute("data-usuario-nom");
                        console.log("Ir a enviar un mensaje a " + usuarioNom);
