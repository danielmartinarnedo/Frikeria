document.addEventListener('DOMContentLoaded', function () {
    ...
    function reportarMensaje() {
        if (reporteDescripcion.value.trim()) {
            fetch('../controladores/normal.php?action=reportarChatPrivado', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                },
                    ...
                    <div class="row d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-11 d-flex justify-items-center align-items-start">
                            <p><span class="me-2">${mensaje.usuarioNom}</span>
                                <svg class="desbloquearUsuario"  data-usuario-nom="${mensaje.usuarioNom}" data-mensaje-id="${mensaje.idMensaje}" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-check-fill" viewBox="0 0 16 16">
